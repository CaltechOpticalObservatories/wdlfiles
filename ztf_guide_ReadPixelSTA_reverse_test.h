...
* Charge is stored on S3 initially */

 0:                          SET SSClock1 TO _GSER_CLOCK_HIGH, SLOW;
                             SET SSClock3 TO _GSER_CLOCK_LOW, SLOW;
.+G_PixelT/3:                SET SSClock2 TO _GSER_CLOCK_HIGH, FAST;
.+G_SWslewT:                 SET SSClock1 TO _GSER_CLOCK_LOW, FAST;
.+G_SWslewT:                 SET SSClock3 TO _GSER_CLOCK_HIGH, SLOW;
                             SET SSClock2 TO _GSER_CLOCK_LOW, SLOW;
504:                    RETURN;
