...
#defeval SCLK_fast_FCS SCLK_fast
...
#defeval SCLK_slow_FCS       SCLK_slow
...
#define _PAR_CLOCK_HIGH_FCS 7.0
#define _PAR_CLOCK_LOW_FCS -6.0
#define _MPP_CLOCK_HIGH_FCS 7.5
#define _MPP_CLOCK_LOW_FCS -5.0
#define _SER_CLOCK_HIGH_FCS 8.0
#define _SER_CLOCK_LOW_FCS -5.0

#define _RG_LOW_FCS 2.0
#define _RG_HIGH_FCS 12.0

#define _SW_LOW_FCS -2.0
#define _SW_HIGH_FCS 6.0
