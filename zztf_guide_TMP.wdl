modulefile zztf_guide.mod
signalfile zztf_guide.signals
...
CALL Wait1us(20)
CALL Wait10ns(5)
CALL GSerialReadRight_smooth(1033)
CALL FGSerialReceiving
CALL Wait1us
CALL GroundBLC
CALL ADClamp
...
CALL Wait10ns(4)
CALL wLine
CALL GSerialReadRight_smooth(2093)
CALL FGSerialReceiving
CALL Wait1us
CALL GroundBLC
CALL ADClamp
...
155 10 0 -5.0
155 10 1 0
297 RETURN GSerialReadRight_smooth
...
210 10 12 -5.0
210 10 13 1
252 RETURN GuideSerialReadRightTop_smooth
...
parameter Abort=0
parameter Delay_FrameStart=264768
parameter Delay_PixelStart=5
parameter Delay_LTStart=358
parameter Guiding=0
parameter GFrames=1
