/* This file contains the triangular clocking, but it reverses
 * the charge in the serial direction so that no charge is 
 * actually read out.  This is the quick test when things are warm */
