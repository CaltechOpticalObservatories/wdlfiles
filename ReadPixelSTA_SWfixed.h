...
/* G_RefSamples: =ChgDump      SET SW TO _GSW_CLOCK_LOW, FAST;*/
...
* so rise time is as long as possible, even extending into next pixel! */
 /* ChgDump+G_SWslewT:            SET SW TO _GSW_CLOCK_HIGH, SLOW;*/
...
0: SET SW TO _GSW_CLOCK_HIGH,FAST;

0:                          SET SSClock1 TO _GSER_CLOCK_HIGH, FAST;
.+G_Test:                  SET SSClock2 TO _GSER_CLOCK_LOW,FAST;
.+G_Test:              SET SSClock3 TO _GSER_CLOCK_HIGH,FAST;
.+G_Test:              SET SSClock1 TO _GSER_CLOCK_LOW,FAST;
.+G_Test:             SET SSClock2 TO _GSER_CLOCK_HIGH,FAST;
.+G_Test:              SET SSClock3 TO _GSER_CLOCK_LOW,FAST;/* Charge dump when S3 falls */
.+G_Test: RETURN;
