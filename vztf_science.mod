...
#define ResetDrain      19
#define ResetGateLow    4 /*5*/
...
SLOT 9 hvbias {
  ...
  HVHC  3 [28,100,0,1];/* Output Drain CCD4 */
  HVHC  4 [28,100,0,1];/* Output Drain CCD1 */
  HVHC  5 [28,100,0,1];/* Output Drain CCD2 */
  HVHC  6 [28,100,0,1];/* Output Drain CCD3 */
}
